...
public class BlogDetailActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            newsid = b.getInt("id");
            newsInfo = BlogInfo.getNewsById(newsid);
            detailInfo = NewsDetailInfo.getDetailByContainId(newsid);
        }
        m_array = BlogInfo.getAll();
        if (m_array != null) {
            if (newsInfo != null) {
                for (BlogInfo news : m_array) {
                    if (news.blogid == newsid) {
                        break;
                    }
                    position++;
                }
        ...
        facebook_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (newsInfo != null)
                    FacebookSharing(BlogDetailActivity.this, newsInfo.link);
            }
        });
        ...
        google_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GoogleSharing(BlogDetailActivity.this);
            }
        });
