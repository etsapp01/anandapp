 ...
 */
public class MediaCoverageDetailActivity extends BaseActivity {
    ...
    ImageView backdrop;
    MediaCoverageInfo newsInfo;
    NewsDetailInfo detailInfo;
    RelativeLayout rlParent;
    ArrayList<MediaCoverageInfo> m_array;
    int position = 0;
    Toolbar toolbar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            postid = b.getInt("id");
            newsInfo = MediaCoverageInfo.getDataById(postid);
            detailInfo = NewsDetailInfo.getDetailByContainId(postid);
        }
        m_array = MediaCoverageInfo.getAll();
        if (m_array != null) {
            if (newsInfo != null) {
                for (MediaCoverageInfo news : m_array) {
                    if (news.mediaid == postid) {
                        break;
                    }
                    position++;
                }
        ...
        facebook_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (newsInfo != null)
                    FacebookSharing(MediaCoverageDetailActivity.this, newsInfo.link);
            }
        });
        ...
        google_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GoogleSharing(MediaCoverageDetailActivity.this);
            }
        });
