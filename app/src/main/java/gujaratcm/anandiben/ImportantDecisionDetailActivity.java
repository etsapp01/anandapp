 ...
 */
public class ImportantDecisionDetailActivity extends BaseActivity {
    ...
    ImageView backdrop;
    ImportantDecisionInfo newsInfo;
    NewsDetailInfo detailInfo;
    RelativeLayout rlParent;
    ArrayList<ImportantDecisionInfo> m_array;
    int position = 0;
    Toolbar toolbar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            postid = b.getInt("id");
            newsInfo = ImportantDecisionInfo.getDataById(postid);
            detailInfo = NewsDetailInfo.getDetailByContainId(postid);
        }
        m_array = ImportantDecisionInfo.getAll();
        if (m_array != null) {
            if (newsInfo != null) {
                for (ImportantDecisionInfo news : m_array) {
                    if (news.desicionid == postid) {
                        break;
                    }
                    position++;
                }
        ...
        facebook_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (newsInfo != null)
                    FacebookSharing(ImportantDecisionDetailActivity.this, newsInfo.link);
            }
        });
        ...
        google_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GoogleSharing(ImportantDecisionDetailActivity.this);
            }
        });
