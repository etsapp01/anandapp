...
public class InterviewFragment extends Fragment {
    ...
    public static InterviewFragment getInstance() {
    ...
    class MyInnerPagerAdapter extends FragmentPagerAdapter {
        ...
        String[] tabs = getResources().getStringArray(R.array.tab_home);
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    ElectronicMediaFragment frag = ElectronicMediaFragment.getInstance();
                    return frag;
                case 1:
                    PrintMediaFragment pop = PrintMediaFragment.getInstance();
                    return pop;
            }
            return null;
        }
